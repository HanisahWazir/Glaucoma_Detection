...
# ============================================================
# 3. LOAD EFFICIENTNET-B4 BASELINE RESULTS
# ============================================================

# Load the previously saved EfficientNet-B4 baseline results
df = pd.read_csv(PROJECT_ROOT / "results" / "baseline" / "efficientnetb4_baseline_results.csv")
...
axes[0].plot(
    ...
    tpr,
    linewidth=2,
    label=f"EfficientNet-B4 (AUROC = {auroc:.4f})"
)
...
axes[1].plot(
    ...
    precision,
    linewidth=2,
    label=f"EfficientNet-B4 (AUPRC = {auprc:.4f})"
)
...
plt.savefig(
    PROJECT_ROOT / "figures" / "figure4.png",
    dpi=300,
    bbox_inches="tight"
)
