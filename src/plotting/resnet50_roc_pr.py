...
# ============================================================
# 3. LOAD RESNET-50 BASELINE RESULTS
# ============================================================

# Load the previously saved ResNet-50 baseline results
df = pd.read_csv(PROJECT_ROOT / "results" / "baseline" / "resnet50_baseline_results.csv")
...
axes[0].plot(
    ...
    tpr,
    linewidth=2,
    label=f"ResNet-50 (AUROC = {auroc:.4f})"
)
...
axes[0].set_title("(a) ROC Curve for ResNet-50 Baseline")
...
axes[1].plot(
    ...
    precision,
    linewidth=2,
    label=f"ResNet-50 (AUPRC = {auprc:.4f})"
)
...
axes[1].set_title("(b) Precision-Recall Curve for ResNet-50 Baseline")
...
plt.savefig(
    PROJECT_ROOT / "figures" / "figure2.png",
    dpi=300,
    bbox_inches="tight"
)
