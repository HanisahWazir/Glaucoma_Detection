...
# Apply DenseNet-121-specific preprocessing and load images in batches during training and evaluation
...
# ============================================================
# 8. BUILD THE DENSENET-121 BASELINE MODEL
# ============================================================

# Load the ImageNet-pretrained DenseNet-121 convolutional backbone
...
# Freeze the pretrained DenseNet-121 layers
...
model.save(PROJECT_ROOT / "models" / "densenet121_baseline.keras")

print(
    "\nSaved the trained model as "
    "'densenet121_baseline.keras'."
)
...
baseline_results_df.to_csv(
    PROJECT_ROOT / "results" / "baseline" / "densenet121_baseline_results.csv",
    index=False
)

print(
    "\nSaved DenseNet121 baseline results to "
    "'densenet121_baseline_results.csv'."
)