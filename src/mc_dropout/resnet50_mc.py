...
# ============================================================
# 6. LOAD THE TRAINED RESNET-50 MODEL
# ============================================================

# Load the previously trained ResNet-50 baseline model
model = tf.keras.models.load_model(PROJECT_ROOT / "models" / "resnet50_baseline.keras")

print("\nLoaded the saved ResNet50 baseline model.")
model.summary()
...
mc_results_df.to_csv(
    PROJECT_ROOT / "results" / "mc_dropout" / "resnet50_mc_dropout_results.csv",
    index=False
)

print(
    "\nSaved image-level MC Dropout results to "
    "'resnet50_mc_dropout_results.csv'."
)